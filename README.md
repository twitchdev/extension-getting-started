...
1. Download the Developer Rig for [Mac](https://developer-rig.twitchcdn.net/Twitch+Developer+Rig.dmg), [Windows](https://developer-rig.twitchcdn.net/Twitch+Developer+Rig+Setup.exe), or [Linux](https://developer-rig.twitchcdn.net/Twitch+Developer+Rig.AppImage). Then, open the downloaded file to install the Rig.
