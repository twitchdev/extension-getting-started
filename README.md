...
1. Download the Developer Rig for [Mac](https://developer-rig.twitchcdn.net/Twitch+Developer+Rig.dmg), [Windows](https://link.twitch.tv/2JcsuGQ), or [Linux](https://link.twitch.tv/2F8hFjw). Then, open the downloaded file to install the Rig.
